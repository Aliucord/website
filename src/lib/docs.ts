...
|PlayableEmbeds fork by Enovale makes the embeds work for every site. Don't use this if you want working YouTube embeds.|[Download PlayableEmbeds fork](https://github.com/Enovale/AliucordPlugins/raw/builds/PlayableEmbeds.zip)|
|PlayableEmbeds fork by Orange32 fixes YouTube embeds.|[Download PlayableEmbeds fork](https://github.com/yutaplug/Aliucord/raw/main/stuff/PlayableEmbeds.zip)|
